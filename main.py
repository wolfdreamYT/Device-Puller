...
# Remember to read ReadMe.txt to import the require libs for the code to work
# Remember not to mess with any of the code EXCEPT the ACCESS_TOKEN = '' 
# Dont use this for unethical hacking, this is for educational purposes only, so please dont do any naughty things!

# remember to replace this token with your own, you can get it at https://ipinfo.io/ since this is my own, and it probably
#  will be used up by the time you get this file. i am not updating the token, it is your responsiblity when downloading.

ACCESS_TOKEN = '061e0ba1407288'
...
def check_if_online():
    """Check if the computer is online by pinging a server."""
    try:
